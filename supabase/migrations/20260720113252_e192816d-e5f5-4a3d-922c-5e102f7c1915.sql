-- Fix stock_to_expense_transfer: products table has no updated_at column.
-- Also honor the expense payment method: unpaid transfers should not require cash flow.
...
BEGIN
  ...
  INSERT INTO public.expenses (date, category, amount, description, payment_method, payment_status, paid_amount)
  VALUES (
